import check from '../admin page/check.png';
 ...
 return (
    ...
    <div className="items-center w-full flex">
        ...
        <div className="items-center  flex">
            ...
            <button onClick={() => reviewcoin(coin._id, coin.coinName, coin.isReviewed)} className="w-8 h-8 rounded-lg contentOuter ml-1 p-1.5">
