import play from '../admin page/play-button-arrowhead.png'
import edit from '../admin page/draw.png';
import trash from '../admin page/trash-bin.png';
 ...
 return (
    ...
    <div className="items-center w-full flex">
        ...
        <div className="items-center  flex">
            ...
            <button onClick={() => activatecoin(coin._id, coin.coinName, coin.isReviewed)} className="w-8 h-8 rounded-lg contentOuter ml-1 p-1.5">
